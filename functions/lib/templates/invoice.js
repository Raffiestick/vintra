...
function computeTotals(input) {
    ...
    const miscTotal = misc.reduce((s, f) => s + n(f === null || f === void 0 ? void 0 : f.amount), 0);
    ...
    const miscPaid = misc.filter(f => !!(f === null || f === void 0 ? void 0 : f.paid)).reduce((s, f) => s + n(f.amount), 0);
...
function pickInvoiceDate(j) {
    var _a, _b, _c;
    return (_c = (_b = (_a = j === null || j === void 0 ? void 0 : j.auctionSaleDate) !== null && _a !== void 0 ? _a : j === null || j === void 0 ? void 0 : j.auctionDate) !== null && _b !== void 0 ? _b : j === null || j === void 0 ? void 0 : j.invoiceDate) !== null && _c !== void 0 ? _c : null;
}
...
// ---------- tiny utils ----------
const esc = (s) => (s !== null && s !== void 0 ? s : "").toString().replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
const usd = (v) => (n(v)).toLocaleString("en-US", { style: "currency", currency: "USD" });
// ---------- main renderer ----------
function renderInvoiceHTML(j, seller, buyer) {
    const { vin, year, make, model, color, odometer, itemPrice, buyerFee, onlineFee, managementFee, miscFees = [], isAuctionPaid, isMgmtFeePaid, invoiceId, jacketNumber, } = (j || {});
    ...
    const miscRows = (miscFees || [])
        .map((f) => `<tr><td class="desc">${esc(f.description || "")}</td><td class="amt">${usd(f.amount)}</td></tr>`)
        .join("");
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="brand">
        ...
        ${seller.dba ? `<div class="dba">DBA ${esc(seller.dba)}</div>` : ""}
        <div class="contact">${esc(seller.phone || "")} | ${esc(seller.email || "")}</div>
      </div>
    ...
    <div class="meta">
      ...
      <div class="cell"><strong>Vehicle:</strong> ${esc(year !== null && year !== void 0 ? year : "")} ${esc(make || "")} ${esc(model || "")}</div>
    ...
    <div class="block">
      <div class="card">
        <h3>SOLD FROM</h3>
        <div><strong>${esc((seller.name || "").toUpperCase())}</strong></div>
        <div>${esc(seller.line1 || "")}</div>
        <div>${esc(seller.line2 || "")}</div>
      </div>
      <div class="card">
        <h3>SOLD TO</h3>
    ...
    <div class="footer">
      RIZEUP VENTURES, LLC • PO BOX 66741, ST PETE BEACH, FL 33706 • ${esc(seller.phone || "616-318-1991")} • ${esc(seller.email || "ADMIN@RIZEUPVENTURES.COM")}<br/>
