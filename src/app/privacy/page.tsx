      ...
      <div className="max-w-4xl mx-auto">
        <Card className="bg-zinc-900 border-zinc-800 text-white">
          ...
          <CardContent className="prose prose-invert prose-zinc max-w-none">
            <p>
              Vintra ("us", "we", or "our") operates the Vintra website (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
            </p>
            ...
            <p>
              Vintra uses the collected data for various purposes:
            </p>
            <ul>
