...
export default function MarketingLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${manrope.variable}`}>
      <body className="min-h-dvh bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(99,102,241,0.25),transparent_60%),radial-gradient(1000px_400px_at_90%_20%,rgba(236,72,153,0.18),transparent_60%),#0b0f1a] text-white antialiased">
        {/* Top nav */}
